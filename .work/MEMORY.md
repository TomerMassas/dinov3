...
## User
- [user_profile.md](user_profile.md) — Tomer's role, company, and expertise
...
- [project_roadmap.md](project_roadmap.md) — Active todos, priorities, and project goals
- [project_progress.md](project_progress.md) — Session-by-session log of work done together
